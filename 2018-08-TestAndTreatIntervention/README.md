...
- **Add vital dynamics** for longer-term STI modeling — see [SI with Vital Dynamics](../2018-08-SIwithVitalDynamics)
- **Model antimicrobial resistance**: Introduce treatment failure or competing resistant strains — see [Competing Strains](../2018-09-CompetingStrains)
- **Extend to multi-stage disease**: Model progression through disease stages with stage-dependent testing and treatment — see [Syphilis](../2018-11-Syphilis)
- **Add cost-effectiveness analysis**: Attach costs to testing and treatment to evaluate intervention efficiency — see [Cost-Effectiveness Analysis](../2021-10-CostEffectivenessAnalysis)
