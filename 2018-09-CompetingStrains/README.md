...
- **Add vital dynamics**: Introduce births and deaths to study longer-term strain competition — see [SI with Vital Dynamics](../2018-08-SIwithVitalDynamics)
...
- **Add a treatment intervention**: Differential treatment efficacy across strains connects to antimicrobial resistance — see [Test and Treat](../2018-08-TestAndTreatIntervention)
