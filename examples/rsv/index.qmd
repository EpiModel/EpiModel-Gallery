...
- **Cross-layer dependency.** The current implementation treats the two layers as independent. See the [SISMID Multi-Layer Networks tutorial](https://epimodel.github.io/sismid/13_multilayer/mod13-Tutorial.html) for a `dat.updates` callback that links degree across layers.
