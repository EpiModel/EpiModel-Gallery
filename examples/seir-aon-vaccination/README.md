...
- **Compare with leaky vaccination** — see [SEIRS with Leaky Vaccination](../seirs-leaky-vaccination) for the alternative vaccine model where protection reduces but does not eliminate transmission
...
- **Add cost-effectiveness analysis** to evaluate the vaccination program's efficiency — see [Cost-Effectiveness Analysis](../cost-effectiveness)
