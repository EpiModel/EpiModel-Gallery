...
- **Multilayer network.** Run the same trace module over a household + casual two-layer network (see [RSV](../rsv/) for a layered pattern). Tracing is layer-aware via the `networks` argument to `get_partners()`.
