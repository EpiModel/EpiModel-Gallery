...
- **Add stage-dependent infectiousness** where transmission probability depends on disease stage (e.g., higher during early infection) — see the [HIV model](../hiv) for this pattern
