---
title: "Multilayer Networks: Cross-Layer Dependency"
...
::: {.callout-note}
## Start with the simpler example first
If you are new to multilayer models, begin with [Multilayer Networks: Independent Layers](../multinets-independent/). That example covers the core mechanics (fitting each layer separately and passing a **list** of network models to `netsim()`) with the layers held independent. This example adds the machinery needed when the layers depend on each other.
:::
